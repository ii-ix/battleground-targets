...
local pvptrinketIDs = {
	[GetSpellInfo(42292)]	= 300,	-- TBC pvp_trinket
	--[GetSpellInfo(42292)]	= 300,	-- Immune Root/Snare/Stun 		Warrior, Hunter, Shaman
...
for class, color in pairs(RAID_CLASS_COLORS) do -- Constants.lua
	...
	classcolors[class] = {r = r, g = g, b = b, colorStr = format("%.2x%.2x%.2x", r*255, g*255, b*255)}
end
